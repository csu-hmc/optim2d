...
movement = 'Winter/SNOPT/Winter_normal';

% general settings
problem.Solver = 'SNOPT';
...
problem.N = 30;
problem.model = standmodel;
problem.initialguess = 'Winter/Winter_normal_result_stand_30.mat';
...
problem.N = 60;
problem.model = standmodel;
problem.initialguess = 'Winter/SNOPT/Winter_normal_result_stand_30.mat';
...
problem.initialguess = 'Winter/SNOPT/Winter_normal_result_stand.mat';  % 'mid';%
...
problem.initialguess = 'Winter/SNOPT/Winter_normal_result_slowest.mat';  % 'mid';%
...
problem.initialguess = 'Winter/SNOPT/Winter_normal_result_slow.mat';
